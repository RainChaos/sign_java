export const LodopFuncs = {
  ...
  beforeInit() {
    ...
    if (this.needCLodop()) {
      ...
      oscript.src = src2
      head.insertBefore(oscript, head.firstChild)
      this.CLodopIsLocal = !!((src1 + src2).match(/\/\/localho|\/\/127.0.0./i))
    }
  },
  ...
  getLodop(oOBJECT, oEMBED) {
    ...
    try {
      ...
      if (this.needCLodop()) {
        ...
        if (!LODOP) {
          // document.body.innerHTML = strCLodopInstall_1 + (this.CLodopIsLocal ? strCLodopInstall_2 : '') + strCLodopInstall_3 + document.body.innerHTML
          // return
        } else {
        ...
        //     LODOP = oEMBED
        //   }
        // } else if (!this.CreatedOKLodop7766) {
