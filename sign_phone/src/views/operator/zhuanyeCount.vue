    ...
    <div class="main-page">
      ...
      <div style="overflow: auto;background:#fff;margin:0px 5px;padding-bottom: 50px">
        ...
        <el-table
                ...
                border
                size="mini">
          <el-table-column fixed="left" label="院系" >
        ...
        <div class="title-ct">各专业列表数据</div>
        <el-table
            ...
            border
            size="mini">
          <el-table-column fixed="left" label="专业" >
            <template slot-scope="scope">{{ scope.row.unit_name }}</template>
          </el-table-column>
          <el-table-column label="报名人数" >
            <template slot-scope="scope">{{ scope.row.student_count }} [{{scope.row.student_count_precent}}]</template>
        ...
        <!--<div class="title-ct">各专业报名/交费/报到人数统计图</div>-->
        <!--<bar-chart style="overflow: hidden;"-->
                   ...
                   <!--height="1360px"-->
        <!--width="100%"/>-->
        <!--<div class="title-ct">各专业报名人数占比图</div>-->
...
<script>
  ...
  import { countZyLists, countXiLists } from '@/api/studentCount'
        ...
        return new Promise((resolve, reject) => {
          ...
          countZyLists(this.params).then(response => {
            ...
            listsData.forEach((row, index) => {
              _this.BmXAxisData.push(row.zhuanye)
              var data = {
                name: row.zhuanye,
            ...
            countXiLists(this.params).then(response => {
                var _this = this
                var listsData = response.data
                var CountNumber = 0
                var PayNumber = 0
